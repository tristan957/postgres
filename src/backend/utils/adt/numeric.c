 ...
 * ----------
 */
static static_singleton const NumericDigit const_zero_data[1] = {0};
static static_singleton const NumericVar const_zero =
{0, 0, NUMERIC_POS, 0, NULL, (NumericDigit *) const_zero_data};

static static_singleton const NumericDigit const_one_data[1] = {1};
static static_singleton const NumericVar const_one =
{1, 0, NUMERIC_POS, 0, NULL, (NumericDigit *) const_one_data};

static static_singleton const NumericVar const_minus_one =
{1, 0, NUMERIC_NEG, 0, NULL, (NumericDigit *) const_one_data};

static static_singleton const NumericDigit const_two_data[1] = {2};
static static_singleton const NumericVar const_two =
{1, 0, NUMERIC_POS, 0, NULL, (NumericDigit *) const_two_data};

#if DEC_DIGITS == 4
static static_singleton const NumericDigit const_zero_point_nine_data[1] = {9000};
#elif DEC_DIGITS == 2
static static_singleton const NumericDigit const_zero_point_nine_data[1] = {90};
#elif DEC_DIGITS == 1
static static_singleton const NumericDigit const_zero_point_nine_data[1] = {9};
#endif
static static_singleton const NumericVar const_zero_point_nine =
{1, -1, NUMERIC_POS, 1, NULL, (NumericDigit *) const_zero_point_nine_data};

#if DEC_DIGITS == 4
static static_singleton const NumericDigit const_one_point_one_data[2] = {1, 1000};
#elif DEC_DIGITS == 2
static static_singleton const NumericDigit const_one_point_one_data[2] = {1, 10};
#elif DEC_DIGITS == 1
static static_singleton const NumericDigit const_one_point_one_data[2] = {1, 1};
#endif
static static_singleton const NumericVar const_one_point_one =
{2, 0, NUMERIC_POS, 1, NULL, (NumericDigit *) const_one_point_one_data};

static static_singleton const NumericVar const_nan =
{0, 0, NUMERIC_NAN, 0, NULL, NULL};

static static_singleton const NumericVar const_pinf =
{0, 0, NUMERIC_PINF, 0, NULL, NULL};

static static_singleton const NumericVar const_ninf =
{0, 0, NUMERIC_NINF, 0, NULL, NULL};

#if DEC_DIGITS == 4
static static_singleton const int round_powers[4] = {0, 1000, 100, 10};
#endif
