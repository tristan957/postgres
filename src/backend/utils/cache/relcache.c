 ...
 */
static static_singleton const FormData_pg_attribute Desc_pg_class[Natts_pg_class] = {Schema_pg_class};
static static_singleton const FormData_pg_attribute Desc_pg_attribute[Natts_pg_attribute] = {Schema_pg_attribute};
static static_singleton const FormData_pg_attribute Desc_pg_proc[Natts_pg_proc] = {Schema_pg_proc};
static static_singleton const FormData_pg_attribute Desc_pg_type[Natts_pg_type] = {Schema_pg_type};
static static_singleton const FormData_pg_attribute Desc_pg_database[Natts_pg_database] = {Schema_pg_database};
static static_singleton const FormData_pg_attribute Desc_pg_authid[Natts_pg_authid] = {Schema_pg_authid};
static static_singleton const FormData_pg_attribute Desc_pg_auth_members[Natts_pg_auth_members] = {Schema_pg_auth_members};
static static_singleton const FormData_pg_attribute Desc_pg_index[Natts_pg_index] = {Schema_pg_index};
static static_singleton const FormData_pg_attribute Desc_pg_shseclabel[Natts_pg_shseclabel] = {Schema_pg_shseclabel};
static static_singleton const FormData_pg_attribute Desc_pg_subscription[Natts_pg_subscription] = {Schema_pg_subscription};
